...
public class RecentActivity extends AppCompatActivity {
    ...
    Context context = RecentActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ServiceClient.get("recent_popular/recent", null, new JsonHttpResponseHandler() {
            @Override
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONArray timeline) {
                ...
                try {
                    for (int i = 0; i < timeline.length(); i++) {
                        ...
                        username.add((String) topic.get("userName"));
                    }
                ...
                topicsListView = (ListView) findViewById(R.id.recentTopicsListView);
